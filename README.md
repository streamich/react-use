...
- [**State**](./docs/State.md)
  ...
  - [`useValidatableState`](./docs/useValidatableState.md) &mdash; tracks state of an object. [![][img-demo]](https://streamich.github.io/react-use/?path=/story/state-usevalidatablestate--demo)

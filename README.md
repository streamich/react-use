...
- [**State**](./docs/State.md)
  ...
  - [`useStateWithCallback`](./docs/useStateWithCallback.md) &mdash; like the regular `useState` but can add a callback as parameter in state setter function, which can get updated state value and do some stuff based on it.

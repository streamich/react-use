...
- [**Sensors**](./docs/Sensors.md)
  ...
  - [`useHover`](./docs/useHover.md) &mdash; tracks mouse hover state of some element. [![][img-demo]](https://codesandbox.io/s/zpn583rvx)
...
- [**State**](./docs/State.md)
  ...
  - [`useCounter` as `useNumber`](./docs/useCounter.md) &mdash; tracks state of a number.

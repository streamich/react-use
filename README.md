...
- [**State**](./docs/State.md)
  ...
  - [`useReducerWithEffects`](./docs/useReducerWithEffects.md) &mdash; colocates your reducer and side effects. [![][img-demo]](https://codesandbox.io/s/use-reducer-with-effects-3fnlv)

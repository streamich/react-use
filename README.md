...
- [**State**](./docs/State.md)
  ...
  - [`useResetState`](./docs/useResetState.md) &mdash; hooks that provide methods to reset state. [![][img-demo]](https://streamich.github.io/react-use/?path=/story/state-useresetstate--demo)
    <br/>
    <br/>
- [**Miscellaneous**]()

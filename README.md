...
- [**State**](./docs/State.md)
  ...
  - [`createSharedState`](./docs/createSharedState.md) &mdash; cross component shared state.[![][img-demo]](https://streamich.github.io/react-use/?path=/story/state-createSharedState--demo)
